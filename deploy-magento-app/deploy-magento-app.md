...
![image-20220117093113967](images/image-20220117093113967.png)
...
1. 连接到之前配置好的虚机，运行下列命令下载github上的Magento安装脚本。
...
8. 访问Magento的网站页面（公网IP地址在Task 4中生成的）。如：`http://129.154.222.255/`。因为还没安装测试数据，所以内容看起来空荡荡的。

    ![image-20220116133157702](images/image-20220116133157702.png)

9. 访问Magento的管理界面（公网IP地址在Task 4中生成的）。如：`http://129.154.222.255/admin`。缺省的用户名为`user`，密码为：`bitnami1`。
